  ...
  routes: [
    ...
    },
    {
      ...
      children: [{
        ...
        name: "供求",
        path: "/index/:type/:isManger/:tabIndex/rent/supply",
        component: supply
      }, {
        name: "消息",
    ...
    //采购部分
    , {
      path: '/estate/purchase',
      // purchase/index
      component: purchase => require(['@/components/rent/estate/serviceList/model'], purchase)
    }
    , {
      path: '/estate/new_purchase',
      component: purchase => require(['@/components/rent/estate/serviceList/purchase/new_purchase'], purchase)
    },
    {
      path: '/my/manager/select_boss',
      component: department_manager => require(['@/components/rent/my/department/department_manager'], department_manager)
    }
    //工作例报
    , {
      path: '/estate/work_report',
      component: work_report => require(['@/components/rent/estate/serviceList/workReport/index'], work_report)
    }
    , {
      path: '/estate/add_work',
      component: add_work => require(['@/components/rent/estate/serviceList/workReport/add_work'], add_work)
    }
    , {
      path: '/estate/model',
      component: model => require(['@/components/rent/estate/serviceList/model'], model)
    }
    //投诉建议
    , {
      path: '/estate/serviceList/complain',
      component: complain => require(['@/components/rent/estate/serviceList/model'], complain)
    }
    , {
      path: '/estate/serviceList/add_complain',
      component: add_complain => require(['@/components/rent/estate/serviceList/complain/addComplain'], add_complain)
    }
    , {
      path: '/estate/serviceList/complain_detail',
    ...
    , {
      ...
      component: settled => require(['@/components/rent/estate/serviceList/model'], settled)
    }
    , {
