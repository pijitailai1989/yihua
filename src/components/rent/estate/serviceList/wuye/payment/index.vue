<template>
  <yd-layout class="layout_my">
    <yd-navbar class="header" slot="navbar" v-show="!userAgent.isWX" title="缴费管理" color="#fff" :bgcolor="mainColor"
      ...
      <yd-icon custom @click.native='$router.push("/estate/serviceList/payment/moneyset")' slot='right' color='#fff'
               class="mr3"
    ...
    <div slot="top" v-show="filter" class="filter foCo9 bgwhite"
      ...
      <div class="flex-row h8 bt bb font32">
        <div class="flex1 jusCenter br" @click="cancelFilter">取消</div>
        <div class="flex1 jusCenter" @click='confirm' :style="{color:mainColor}">确定</div>
      </div>
    </div>
    <div class="mask" v-if='filter' style="top:1.88rem;z-index:1" slot="bottom" @click="cancelFilter"></div>
    <yd-infinitescroll :callback="loadList" ref="infinitescrollDemo">
      ...
      <div slot="list">
        <div class="content" v-for="(item,index) in contentList" :key="index"
             @click="turnTo('/estate/serviceList/wuye/payment/expense/'+item.guid+'#'+item.type)">
          <div class="top">
            <div class="flex-row">
            ...
            <span class="state0 state" v-if='item.state==0'>未缴</span>
