<template>
  <yd-layout class="layout_my">
      <yd-navbar class="header" slot="navbar" v-title="'装修管理'" v-show="!userAgent.isWX" title="装修管理" color="#fff" :bgcolor="mainColor" height=".88rem">
        ...
        <span @click="turnTo('/estate/serviceList/wuye/renovation/declares')" slot="right" class="edit spanRight" style="color: #fff;font-size:.6rem;">+</span>
      </yd-navbar>
    <div class="search">
      <div>
        <i @click="searchFn">
    ...
    <div class="contentList" @scroll="scrollHandler" ref="listDom">
      <div class="content" v-for="(item,index) in contentList" :key="index" @click="turnTo('/estate/serviceList/wuye/renovation/details?guid='+item.guid)">
        <div class="top">
          ...
          <span v-if="item.status == 2" class="pdlr1 state state2">经理审批</span>
