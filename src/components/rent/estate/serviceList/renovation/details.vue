...
<div style="height:100vh" >
  <yd-layout class="layout_my" v-if="showUser && showInput">
    ...
    <div class="flex-row h9 radius jusCenter font32" v-if="tasks && decoration.status == 3" :style="`background:${mainColor};margin:.3rem .5rem;color:#fff`" @click="rentConfirm" >确定</div>
    <!-- 客服上报 -->
    ...
    confirmComplete(){
      this.$dialog.confirm({
        ...
        opts:()=>{
          ...
          this.$ajax(`${this.subUrl.activity}/decoration/userConfirm`,data,res=>{
