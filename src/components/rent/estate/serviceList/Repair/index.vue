<template>
  ...
  <yd-layout class="layout_my">
    <yd-navbar class="header" slot="navbar" v-show="!userAgent.isWX" v-title="'报修处理'" title="报修处理" color="#fff" :bgcolor="mainColor"
      ...
      <div slot="right" class="edit addRightClickArea" style="color: #fff;font-size: .6rem;" @click="$router.push('/estate/to_repair')">+</div>
    </yd-navbar>
          ...
          <router-link :to="'/estate/wuye/order_detail?guid='+item.guid" slot="left">
            ...
            <div class="first-div flex-row">
              ...
              <span class="pull-right">
                ...
                <span class="pull-right state stateClose" v-if="item.status==10">客服评价关闭</span>
              </span>
            </div>
