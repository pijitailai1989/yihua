<template>
  <yd-layout class="layout_my">
    <yd-navbar class="header" slot="navbar" :title="title" color="#fff" :bgcolor="mainColor" height=".88rem">
      ...
      <img style="width: .4rem;height:.4rem;" v-if='userInfo.organType == 3' @click='$router.push("/estate/serviceList/wuye/settled/add")' slot='right' src="../../../../../assets/images/rent/my/add_new_job.png"
        alt="">
    </yd-navbar>
    <!-- 1111111111111 -->
