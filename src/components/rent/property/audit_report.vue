...
<div style="height:100vh">
  ...
  <yd-layout v-show="showshow" class="layout_my">
    <div class="blue_box" >
      <yd-navbar class="header" v-show="!userAgent.isWX" title="填下稽查报告" color="#fff" :bgcolor="mainColor" height=".88rem">
    ...
    <yd-cell-group>
        <yd-cell-item arrow type="label" @click.native="open">
            <span slot="left" class="textHidden" style="width:5rem;">{{parameter.name?parameter.name:'稽查对象'}}</span>
        </yd-cell-item>
    </yd-cell-group>
    ...
    <div class="details">
        <div class="inputText">
          <ul>
            ...
            <span>
                 <yd-datetime type="date" v-model="parameter.examineDate" slot="right"></yd-datetime>
            </span>
          </li>
          </ul>
          <ul>
            ...
            <span>
              <input type="text" v-model="parameter.examineLead" placeholder="">
            </span>
          </li>
          </ul>
          <ul>
            ...
            <span>
              <input type="text" v-model="parameter.examineMember" placeholder="">
            </span>
          </li>
          </ul>
        </div>
    ...
    <yd-button-group slot="tabbar" style="margin-bottom:.2rem;">
        <yd-button :bgcolor="mainColor"  @click.native="submitProExamine" color="#fff" size="large" type="primary">确定</yd-button>
    </yd-button-group>
...
export default {
  ...
  methods: {
    ...
    submitProExamine(){
        ...
        this.xhr.post(`${this.subUrl.activity}/propertyExamine/submitProExamine`, qs.stringify(data) ).then((res) => {
          if (res.data.code == 1) {
