<template>
   <yd-layout class="myLibrary" v-title="'我的产品'">
     <yd-navbar height=".88rem" slot='navbar' v-show="!userAgent.isWX" title="我的产品" :bgcolor="mainColor" color="#fff">
       <div class="addRightClickArea foCoF font28" slot="right" @click="turnTo('/supply/product/release_products')">发布产品</div>
     </yd-navbar>
        <div class="search">
             <ul>
		   ...
		   <div class="entrance" style="border-top:1px solid #D9D9D9;">
            ...
            <i><img src="../../../assets/images/rent/supply/gongshang.png" alt=""></i>
				  ...
				  <li @click="turnTo('/supply/product/my_card?oName='+organInfo.organName+'&a=1')">
