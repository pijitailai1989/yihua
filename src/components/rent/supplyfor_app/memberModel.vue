<template>
  <div style="height: 100vh;">
    <yd-layout class="layout_my" v-show="showAdd">
      <yd-navbar class="header" slot="navbar" v-show="!userAgent.isWX" v-title="'选择人员'" title="选择人员" color="#fff"
                 :bgcolor="mainColor" height=".88rem">
        <a @click.stop="back()" slot="left"><!--url[url.length-1]-->
          <yd-navbar-back-icon color="#fff"></yd-navbar-back-icon>
        </a>
        <!--<div slot="right"  @click="showAdd = false" class="addRightClickArea" style="color: #fff;">-->
          <!--添加-->
        <!--</div>-->
      </yd-navbar>
      <div class="list-top">
        ...
        <ul v-if="showRightImg" class="oul selected_footer">
          <li style="padding-left: .2rem;">
            ...
            <div class="bottom-del flex center jusCenter"  :style="{background: mainColor,textAlign:'center',padding:0}" @click.stop="delPeople()">确定</div>
