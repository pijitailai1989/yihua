<template>
  <div style="height: 100vh;">
    <yd-layout class="edit" v-if="showMechant">
      ...
      <div class="flex-row-nowarp h9 bt bgwhite font32" style="color:#f2725e" slot="bottom">
        <!--<div class="flex1 jusCenter center">-->
        <!--<img src="../../../../assets/images/rent/my/admin/disagree.png" style="width: .4rem;margin: .05rem 0.1rem 0 0;" alt="">-->
        <!--<span>不通过</span>-->
        <!--</div>-->
        <div class="flex1 jusCenter center" @click="showMechant = false">
    ...
    methods: {
      chooseMechant(e){
        ...
        if(e){
          ...
          let data = {
            token:this.$getkey(),
            type:this.$route.params.type == 1?7:6,
            guid:this.$route.params.guid,
            userIdList:e,
            guid:this.$route.params.guid,
          }
          this.$ajax(`${this.subUrl.bd}/buildingBuy/recommendBusiness`,data,res=>{
