<template>
  <yd-layout class="layout_my">
    <yd-navbar class="header" slot="navbar" v-show="!userAgent.isWX" title="管理处月度报告" color="#fff" :bgcolor="mainColor"
               height=".88rem">
    ...
    <yd-infinitescroll :callback="loadList" ref="infinitescrollDemo">
      <div class="contentList" slot="list">
        ...
        <div class="list bgwhite pdlr2 mt2">
          <ul class="font26 flex-row" style="color:#333;justify-content:space-between">
            <li class="flex-row foCo6">
            </li>
            <li>
              <span class="pdlr1 state state0">关闭</span>
          ...
          <div class="flex-row-nowrap" style="padding:.2rem 0;" @click="turnTo('/monthly/details')">
            ...
            <div style="flex:1;">
              ...
              <div class="flex font26 foCo9 mt1">
                <span>2018-1-19</span>
                <span class="flex">上报时间:2018-1-19</span>
              </div>
            </div>
          </div>
