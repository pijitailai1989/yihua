<template>
  <yd-layout class="layout_my">
    ...
    <yd-search class="search" slot="top" :result="result" fullpage v-model="value2" :item-click="itemClickHandler"
  ...
  export default {
    ...
    methods: {
      ...
      getDepartmentInfo(cb) {
        ...
        this.xhr.post(`${this.subUrl.user}/admin/deptManage/organDepartmentInfo`,this.$qs.stringify(data)).then((res) => {
          if (res.data.code == 1) {
            console.log(res)
