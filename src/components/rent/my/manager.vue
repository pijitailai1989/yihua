...
<yd-layout class="layout_my">
    <div class="blue_box" :class="{blue:userInfo.organType == 4,green:userInfo.organType == 1,orange:userInfo.organType == 5}">
      ...
      <div class="center_info">
        ...
        <div class="my_info">
          ...
          <div class="m-account" v-if="(userInfo.organType!=5)">岗位:{{userInfo.postName}}</div>
        </div>
      </div>
      <div class="bottom" :class="{bottom1:userInfo.organType == 5}">
        <div class="bumenBox" v-if="!(userInfo.organType == 5)">
          ...
          <img v-else-if="userInfo.organType == 2" if="rParams.type == 2"
    ...
    <div class="content">
      <div class="eidt_code">
        ...
        <div class="edit_content">
          <input type="text" style="height: 100%" maxlength="20" v-model="organInfo.inviteCode">
  ...
  export default {
    data() {
      return {
        ...
        about: {
          name: "关于",
          img: require('../../../assets/images/rent/my/about.png'),
