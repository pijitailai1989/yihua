<template>
  <div class="circle" v-title="'我的圈子'" v-if="showContent">
    <yd-navbar class="searchTitle" height=".88rem" v-show="!userAgent.isWX" title="我的圈子" :bgcolor="mainColor"
               color="#fff">
    ...
    <yd-layout class="layout">
      ...
      <div @click="turnTo('/my/circle/newActivity')" slot="bottom" :style="{background:mainColor}" class="toEdit">
        <!-- <span :style="{background:mainColor}" style="">发帖</span> -->
        <yd-icon name='edit' size='.6rem' custom color='#fff'></yd-icon>
      </div>

      <div @click="turnTo('/circle/my_circle?circle=1' )" slot="bottom" :style="{background:mainColor}"
           class="manager toEdit">
        <!-- <span :style="{background:mainColor}" style="">发帖</span> -->
        <!-- <yd-icon name='edit' size='.6rem' custom color='#fff' ></yd-icon> -->
        <img width="70%" class="myManager" src="../../../../assets/images/rent/circle/manager.png">
      </div>
