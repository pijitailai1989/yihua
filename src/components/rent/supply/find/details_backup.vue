<template>
  <yd-layout class="layout_my">
        ...
        <div class="info">
          <ul>
            ...
            <li><span>所在地</span>
              ...
              <a :style="{border:'1px solid'+mainColor,color:mainColor}">
      ...
      <div class="alertText" v-show="alertT">
        <ul>
          ...
          <li class="a" v-show="this.bm.type==2||this.bm.type==1"><p class="font28">地址：</p><span><input
            v-model="bm.remarks" type="text" placeholder="请填写"></span></li>
          <li class="a b"><p class="font28" v-show="this.bm.type==2||this.bm.type==1">备注：</p>
            <p class="font28" v-show="this.bm.type==3">我的留言：</p>
            <span style="height:1.4rem;"><textarea v-model="bm.address"></textarea></span></li>
          <li>
    ...
    <yd-tabbar slot="tabbar" v-show="this.userId!=productInfo.userId">
      <yd-tabbar-item title="免费预约" link="#" @click.native="alert(2)">
        <yd-icon name="ucenter-outline" slot="icon"></yd-icon>
      </yd-tabbar-item>
      <yd-tabbar-item title="参加团购" link="#" @click.native="alert(1)" v-if="productInfo.isGroup!=0">
        <yd-icon name="ucenter-outline" slot="icon"></yd-icon>
      </yd-tabbar-item>
    </yd-tabbar>
  </yd-layout>
