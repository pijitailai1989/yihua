<template>
  <div class="templateOuter" v-title="title">
    <yd-layout class="article_tmp">
      ...
      <div class="session">
          <div class="top">
            <img class="header"  @click="$router.push(`/circle/my_circle/friend_detail/${info.bbs.userId}?showRemark=1`)" :src="info.bbs.headPortrait">
            <div class="t-content">
          ...
          <div class="infinite" >
            <div class="bottom" slot="list">
              ...
              <div class="b-item" v-for="(item,idx) in components" :key="idx">
                <!--上面部分-->
                <div class="c-info">
                  <div class="c-i-header"><img  @click="$router.push(`/circle/my_circle/friend_detail/${item.userId}?showRemark=1`)" :src="item.headPortrait"></div>
                  <div class="c-i-name">
