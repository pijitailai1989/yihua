<template>
  <div class="circle" v-title="'八爪圈'">
    ...
    <yd-navbar class="searchTitle" height=".88rem" v-show="!userAgent.isWX" title="八爪圈" :bgcolor="mainColor" color="#fff">
        <router-link to="/circle/my_circle" slot="right">
      ...
      <div>
        <div class="circle_session" ref="circle_session">
          ...
          <yd-slider autoplay="3000"  style="height:2.4rem" v-show="!imgs" :loop="false" >
            <!-- 对数据进行筛选 -->
            <yd-slider-item>
                <a><img src="http://static.ydcss.com/uploads/ydui/1.jpg"></a>
              </yd-slider-item>
              <yd-slider-item>
               <a><img src="http://static.ydcss.com/uploads/ydui/2.jpg"></a>
             </yd-slider-item>
              <yd-slider-item>
                <a><img src="http://static.ydcss.com/uploads/ydui/3.jpg"></a>
              </yd-slider-item>
          </yd-slider>
          <!-- 公告 -->
          <div class="announce" v-show="imgs" style="height:2.4rem">
            <div v-for="(item,key) in announce" :key="key" @click="goTo(item.guid)">
              <b>【{{item.typeName}}】</b>
              ...
              <div v-if="show1">
                 ...
                 <div class="hierarchy">
                   ...
                   <ul v-if="classifyList1.length>0" style="background:#F8F9FA;">
                      ...
                      @click="getbbsType(false,index,item.dictDataName,item.guid)">{{item.dictDataName}}</li>
                   </ul>
...
<style scoped>
  /* 文字图标 */
  .show{position:fixed;width:100%;height: calc( 100vh - 4rem );
...
.circle .yd-slider{
  ...
  .announce>div:nth-child(1)>b{color:#fab23e;}
  .announce>div:nth-child(2)>b{color:#ef6a6f;}
  .announce>div:nth-child(3)>b{color:#0093d2;}
</style>
