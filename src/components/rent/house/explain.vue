<template>
  <yd-layout class="edit">
    <yd-navbar height=".88rem" slot='navbar' v-show="!userAgent.isWX" title="设备维护明细说明" :bgcolor="mainColor" color="#fff">
   ...
   <div class="explain">
       <ul>
           <li style="color:#777;">工作内容</li>
           <li style="border-bottom:1px solid #999;">工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容工作内容</li>
           <li style="color:#777;">标准细化点</li>
           <li style="border-bottom:1px solid #999;">标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点标准细化点</li>
           <li style="color:#777;">截止时间</li>
           <li style="border-bottom:1px solid #999;">2017-7-30</li>
           <li style="color:#777;">责任人</li>
           <li style="border-bottom:1px solid #999;">王老五</li>
           <li style="color:#777;">进度结论</li>
           <li style="border-bottom:1px solid #999;">60%</li>
       </ul>
   </div>
